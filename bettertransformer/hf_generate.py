...
def parse_args() -> Namespace:
    ...
    parser.add_argument('--device_map', type=str, default=None) #With accelerate can pass value auto"
    parser.add_argument('--load_in_8bit', type=bool, default=False) #With bitsandbytes can use Int8 pass True")
    parser.add_argument('--better_transformer', type=bool, default=False)
...
def main(args: Namespace) -> None:
    ...
    try:
        ...
        if args.better_transformer == True:
            try:
                print(f"Converting to Better Transformer ... {args.better_transformer}")
                ...
                print("Proceeding without BetterTransformer")
    ...
    encoded_inp = tokenizer(args.prompts, return_tensors='pt', padding=padding)
