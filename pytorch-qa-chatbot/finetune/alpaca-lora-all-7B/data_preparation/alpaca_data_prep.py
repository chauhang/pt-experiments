...
if __name__ == "__main__":
    ...
    parser.add_argument("--pt_docs_dataset_path", type=str, default="docs_qa_dataset.json")
    parser.add_argument("--pt_blogs_discuss_path", type=str, default="blogs_qa_dataset.json")
    ...
    generate_data_in_alpaca_format(df=final_df, output_file_path="pytorch_all_alpaca_format.json")
