...
class TransformersSeqClassifierHandler(BaseHandler, ABC):
    ...
    def initialize(self, ctx):
        ...
        if self.setup_config["save_mode"] == "torchscript":
            ...
            if self.setup_config["mode"] == "sequence_classification":
                ...
                config = AutoConfig.from_pretrained("bigscience/bloom-7b1", revision="850ba1758a7744fedae78caadc152625133b1677")
                self.model = AutoModelForCausalLM.from_pretrained("bigscience/bloom-7b1", device_map='sequential', offload_folder="offload", offload_state_dict = True, torch_dtype=torch.float16)
    ...
    def inference(self, input_batch):
        ...
        if self.setup_config["mode"] == "sequence_classification":
            predictions = self.model(input_ids_batch)
            print(
